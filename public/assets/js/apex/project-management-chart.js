(function($) {
    ...
    var options = {
        ...
        colors: ["#5d87ff", '#ffc107', '#28c76f', '#ee368c'],
    };
    var chart = new ApexCharts(document.querySelector("#projects_overview"), options);
    chart.render();
    ...
    var chart = new ApexCharts(document.querySelector("#completed_review"), options);
    chart.render();
    ...
    var options = {
        ...
        labels: ["Complete", "Assigned", "Active", "Pending"],
        chart: {
            height: 400,
            type: 'donut',
        },
    ...
    document.querySelector("#tasks_performance").innerHTML = " ";
    ...
    function displayCurrentTime() {
        ...
        var formattedTime = currentTime.toLocaleTimeString(undefined, options);
