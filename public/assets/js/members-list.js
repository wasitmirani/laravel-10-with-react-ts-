    ...
    function addContact() {
        $("#btn-add").click(function () {
            ...
            $html =
                ...
                '<img src="assets/images/user/user-1.jpg" alt="avatar" class="rounded-circle" width="50">' +
                '<div class="ms-3">' +
                '<div class="user-meta-info">' +
                '<h6 class="user-name mb-0 fw-medium fs-15" data-name=' +
                $_nameValue +
                ">" +
                $_nameValue +
                "</h6>" +
                '<span class="user-work text-body" data-occupation=' +
                $_occupationValue +
                ">" +
                $_occupationValue +
                "</span>" +
                ...
                "</td>" +
                "<td>" +
                '<span class="usr-email-addr text-body" data-email=' +
                $_emailValue +
                ">" +
                $_emailValue +
                "</span>" +
                "</td>" +
                "<td>" +
                '<span class="usr-location text-body" data-location=' +
                $_locationValue +
                ">" +
                $_locationValue +
                "</span>" +
                "</td>" +
                "<td>" +
                '<span class="usr-ph-no text-body" data-phone=' +
                $_phoneValue +
                ">" +
                $_phoneValue +
                "</span>" +
                ...
                '<a href="javascript:void(0)" class="text-primary text-decoration-none fs-18 edit"><i class="ri-eye-line"></i></a>' +
                '<a href="javascript:void(0)" class="text-danger ms-2 text-decoration-none fs-18 delete"><i class="ri-delete-bin-7-line"></i></a>' +
                "</div>" +
                "</td>" +
                "</tr>";
