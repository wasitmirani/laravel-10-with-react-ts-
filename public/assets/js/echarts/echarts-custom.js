(function($) {
    ...
    var dom = document.getElementById('chart_gradient');
    var myChart = echarts.init(dom, null, {
        renderer: 'canvas',
        useDirtyRect: false
    });
    ...
    //  Bar with Background
    var dom = document.getElementById('bar_with_background');
    var myChart = echarts.init(dom, null, {
        renderer: 'canvas',
        useDirtyRect: false
    });
    ...
    // Label Position
    var dom = document.getElementById('label_position');
    var myChart = echarts.init(dom, null, {
        renderer: 'canvas',
        useDirtyRect: false
    });
    ...
    var dom = document.getElementById('example_dataset');
    var myChart = echarts.init(dom, null, {
        renderer: 'canvas',
        useDirtyRect: false
    });
    ...
    //  Symbol Shape Morph
    var dom = document.getElementById('symbol_shape_morph');
    var myChart = echarts.init(dom, null, {
        renderer: 'canvas',
        useDirtyRect: false
    });
    ...
    // Nightingale Chart
    var dom = document.getElementById('nightingale_chart');
    var myChart = echarts.init(dom, null, {
        renderer: 'canvas',
        useDirtyRect: false
    });
